...
<section class="full-height text-center">
	<div class="inner-wrap">
		...
		<p>
			<a href="https://findmypast.co.uk/family-tree" target="_blank">findmypast.co.uk/family-tree</a>
		</p>
...
!-->
			<div class="intro-paragraph">
				<p >Charged with leading on the UX & research of this successful post sign-up onboarding experiement within a lean & agile product/software team of 6.</p>
...
-->
	<div class="normal-width">
		...
		<p>I was charged with leading on the UX, User Research and Visual Design (and occasional Product Owner duties).
		</p>
		<p>The company, team and I were working with OKR’s (Objectives & Key Results is a framework for defining and tracking objectives and their outcomes), following Lean & Agile software development principles. Each quarter (of the year) we were tasked with defining new OKR’s.
		</p>
	</div>
	...
	<div class="normal-width">
		...
		<p>It was the beginning of the quarter and we had to define what we thought was the <span class="bold">right</span> problem to solve for our users (objective) while adhering to the business goals. Following that, we had to come up with a viable strategy on how to tackle it and how best to measure our success (key results).
		</p>
		<p>
			In order to help us do that and as with all our pre-decision making, we first accumulated all existing previous data we had and/or carry out additional research we thought necessary but unavailable. This consisted of user research, competitor analysis and quantitative data metrics.
		</p>
		...
		<ul class="content-list-ordered">
			<li>
				<span class="list-number">1)</span> The tree was a complex product that was suited more for intermediates
			</li>
			<li>
				<span class="list-number">2)</span> Beginner users felt overwhelmed from the high educational and knowledge barrier for entry
			</li>
			<li>
				<span class="list-number">3)</span> Beginners wanted to be ‘hand-held’ throughout the experience
			</li>
		</ul>

		<h3>Competitor analysis</h3>
		<p>
			To further help our decision making be data-informed, I thought it useful to get a better understanding of our competitors strengths and weaknesses and what worked for them. That kind of research didn’t exist at the time, so I conducted and documented in-depth analysis which I then relayed onto to the rest of the team.
		</p>
	...
	<div class="normal-width">
		...
		<p>
			To begin, I spent some time on each competitor product where I noted down my thoughts as I onboarded and explored each product. Then, I mapped out each journey in the form of page flows and assessed the types of features each competitor had and how their business model was structured. All learnings of which was documented into key summaries.
		</p>
	</div>
	...
	<div class="normal-width">
		<p>
		Deriving from the above, I then grouped everything together in the form of several key themes. These were put into a spider/radar chart diagram where I ranked each from 0–5 (0 being non-existent and 5 being excellent).
		</p>
		<p>
			It’s not an exact science and thus some themes can be subject to opinion, but I felt it would be helpful to have this extra layer of qualitative data to hand when we congregated at the decision table.
		</p>
		<p>
		Ultimately, It’s a quick way to visually distinguish strong and weak areas of our competitors in comparison to our own as well as identifying patterns and gaps. This could also be built upon and reused going forward for all future experiments.
		</p>
		...
		<p>Before we jumped into ways we could achieve the above objective, It was important to reiterate the types of users whom we would be designing for. Below was one of the pre-defined primary personas/user profiles we were working with:
		</p>
	</div>
	<div class="normal-width">
			<figure class="spaced">
	...
	<div class="normal-width">
		...
		<p>To help us validate our assumptions and inform us which type of user we should be focusing on when it came to design solutions, we wanted to know exactly what percentage of our traffic were beginners who were signing up.
		...
		<p>In order to clear that up once and for all, we had devised a quick experiment were we would ask the user if they were a beginner, intermediate, or expert upon signing up. Since this question alone could produce a subjective answer, we added an additional question which asked “How long have you been researching your family history?” — this would help us further understand how they defined themselves in comparison to how we would define these 3 labels.
		</p>
	...
	<div class="normal-width">
		...
		<p>The results showed that in fact, the vast majority of new users classified themselves as beginner with 0–1 months experience. This experiment was then rolled out to the rest of the product journeys were it was discovered that near identical results persisted.
		</p>
...
`	<div class="normal-width">
	...
	<div class="normal-width">
		...
		The workshop produced many great ideas which I grouped into themes and later used for inspiration.
		</p>
		...
		<p>One of the better solutions I thought, was to have a visually clear step-by-step process which added family members 1 at a time before they reached the tree itself. This solved several problems:
		</p>
		<ul class="content-list-ordered">
			<li>
				<span class="list-number">1)</span> Overcame our technical blockers
			</li>
			<li>
	...
	<div class="normal-width">
		...
		<p>Having then tested these sketches with a few colleagues, a few of them expressed their skepticism (and rightly so) on this particular direction, as I was informed that a similar experiment had failed previously which looked like the below:
		</p>
	</div>
	...
	<div class="normal-width">
		<p>
			However, I felt strongly that this wasn’t necessarily down to the concept itself, but rather, the execution. With some healthy debate, we were all onboard to explore this idea further.
		</p>

		<h2>Design & Testing (part 2) : Mid-Fidelity Prototype</h2>
		<p>
			I then quickly created a simple greyscale clickable prototype which we (a user research specialist and myself) user tested with 5 external participants that matched our user demographics.
		</p>
	</div>
	...
	<div class="normal-width">
		...
		<ul class="content-list-ordered">
			...
			<li>
				<span class="list-number">2)</span> It clear to participants what the ‘correct’ format of the ‘year of birth’ input was and how that might effect their result made them feel uneasy (despite the example text ‘1965’ that displayed the correct format)
			</li>
			<li>
	...
	<div class="normal-width">
		<p>
			As with all my designs, I made sure that I pinned them up at regular intervals for everyone to see. That way I could get frequent useful feedback throughout the process as and when colleagues felt ready to give it.
		</p>
	</div>
	...
	<div class="normal-width">
		...
		<ul class="content-list-ordered">
			...
			<li>
				<span class="list-number">2)</span> Mobile: The skip link and call to actions were hidden away on smaller resolutions underneath the fold (the viewable area without the need for scrolling).
			</li>
			<li>
			...
			<li>
				<span class="list-number">4)</span> Making the previous decision to introduce the ‘dropdown list/menu’ for the ‘year or birth’ presented it’s own problems — it meant that participants were having to scroll for some time in order to select the right date which they found tedious, particularly when taking into consideration that they were potentially going to do this up to 7 times
			</li>
		</ul>
	</div>
	<div class="normal-width">
	...
	<div class="normal-width">
		...
		<ul class="content-list-ordered">
			<li>
				<span class="list-number">1)</span> We experimented with having the avatar boxes ‘slide’ horizontally as to have it always be centred in the middle on the relevant family member (ultimately though this presented some technical challengers so we decided to settle on having a clear bold title within the form accompanied by a mini icon replicating the family members avatar).
			</li>
			<li>
			...
			<li>
				<span class="list-number">4)</span> We devised a way to only have possible/relevant date ranges depending on how old the user was— this made scrolling to the right date much more efficient on all following family member forms.
			</li>
		</ul>


		<h2>Build Execution & Release Plan</h2>
		<p>For storytelling purposes and readability, I thought it best to explain things linearly as structured above. In reality, we had more than enough evidence some time prior to this point that our idea was good enough to warrant testing this for real in the form of A/B testing (a method used to split user traffic 50%/50% to compare it’s performance against the current live build).
		</p>
	...
	<div class="normal-width">
		<h2>The Outcome</h2>
		<p>We managed to hit our overall objective and 2 out of 3 of our key result goals.</p>
		<p>Results showed we had upped user engagement by 150% and increased conversion (paid subscriptions) by 6%.
		</p>
	...
	<div class="normal-width">
		...
		<p>All said and done, we learned that beginner users really liked clear guided bite-sized onboarding steps to help overcome the trees overwhelming nature and usability complexity (to which we were powerless to improve).
		</p>
	</div>
	...
	<div class="normal-width">
		<p>In closing, the biggest key take away I think, was that there is a fine line between what is minimally viable for the user and what is not — and with that, and although a difficult judgment call, we should always approach with caution when when deciding to experiment too early before they have had chance to be fully fleshed out.
		</p>
		<p>Although the previous ‘add parents’ experiment, unfortunately, had failed, the concept itself turned out to be solid — it just needed a different approach.
		</p>
	...
	<div class="prototype-link normal-width">
		<p>
			Live link: <a href="https://findmypast.co.uk/family-tree" target="_blank">https://findmypast.co.uk/family-tree</a>
		</p>
	</div>
