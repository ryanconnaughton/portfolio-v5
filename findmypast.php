...
!-->
			<div class="intro-paragraph">
				<p>This case study is intended to illustrate some of my UX processes and methodologies for end-to-end evidence-based collaborative problem solving within a product company.
				</p>
...
-->
	...
	<div class="normal-width">
		...
		<p>In addition to successfully making the rounds much shorter, I was told the hat method helped their thinking be more focused while also making them much more comfortable in giving 'negative feedback', which tended to be a problem for participants from previous experiences conducting similar workshops.
		</p>

		<h3>Workshop Outcome</h3>
		<p>Finally, with colour coded feedback post-its scattered on each pinned up design around the room (which gave a visual indication of which were the more liked ideas). We finished up by summarising the overall themes which were:
		</p>
		<ul class="content-list-ordered">
			<li>
	...
	<div class="normal-width">
		...
		<p>First, using post-its, we listed out all the possible tasks that could be carried out on the tree. Then, we mapped out which ones we felt brought the most value to the user followed by how complex each of those tasks was by the number of steps they had to take to complete them. We then ranked them all ‘high’, ‘medium’ or ‘low’ in impact and difficulty which we then used as a guide for prioritising their order.</p>
	...
	<div class="normal-width">
		...
		One of the key iterations made here was the introduction of a permanently viewable step-by-step ‘text instructions’ bar for each task as to not force the user to repetitively minimise and maximise the below tab when interacting with the product (this will become more clear in the next section).
		</p>
	</div>
	...
	<div class="spaced lg-width">
		<div class="spaced">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="image-descrip">Sketches: One of the more successful internally tested wireframes
					</div>
				</div>
			</div>
		</div>
	...
	<div class="normal-width">
		...
		<p>Following a few iterations on the user tested sketches, I decided to move quickly to a mid-fidelity wireframed prototype. I decided on greyscale at this point in order to focus the discussion and feedback solely on the idea concepts rather than the aesthetics.</p>
		<p>I tested these internally with different colleagues around the business.
		One of the key iterations made here was the introduction of a permanently viewable step-by-step ‘text instructions’ bar for each task as to not force the user to repetitively minimise and maximise the below tab when interacting with the product (this will become more clear in the next section).</p>

		<h3>External user testing</h3>
		<p>Again, due to a looming deadline, we didn’t have adequate time to test both the mobile and the desktop versions. Suffice to say though, a high majority of our users tended to use higher screen resolutions when actually <bold><italic>using</italic></bold> our tree product (i.e tablets and desktops), albeit mobile is higher in initial ‘sign-ups’.</p>
	</div>
	...
	<div class="normal-width">
		...
		<p>
		<p>In the end, within just 2 weeks, we had identified/defined a problem, designed, prototyped and tested what would have been a complex and thus expensive feature to implement. Furthermore, we had generated a foundation of ideas and learnings for the backlog to be picked up for potential future experiment exploration — all without writing one line of code.
		</p>
	</div>
