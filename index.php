...
$pageTitleTag = 'Ryan Connaughton - UX Portfolio';
$getMetaDescription = 'Ryan Connaughton\'s Portolio - UX/Product Designer & User Researcher';
$getMetaKeywords = 'UX, User Experience, User Experience Designer, Product Designer, User Researcher, Visual Designer';
...
<section class="full-height intro text-center">
	...
	<div class="text-area">
		...
		<div class="btn-set-container-desktop">
			<a href="ryan_connaughton-cv-resume.pdf" class="btn resume-btn" download>View my CV/Resumé</a>
...
<main id="main" role="main" class="container">
				...
				<nav class="work-filter text-right">
					<ul>
						<li class="current_page_item2">
							<a href="#" data-filter="*" class="active">Visual + UX Design</a>
						</li>
						<li>
							<a href="#" data-filter=".ux">
							 UX Only
							</a>
						</li>
					</ul>
	...
	<div class="row isotope normal-column-gallery">
		...
		<article class="column-view col-xs-4 gallery ux" data-work="globaldrum" data-title="Globaldrum">
			<div class="picture-container">
				<picture>
					<source media="(max-width: 799px)" srcset="img/thumbs/globaldrum.jpg" />
					<source media="(min-width: 800px)" srcset="img/thumbs/globaldrum.jpg" />
					<img class="placeholder" src="img/work/placeholder-img-square.png" data-src="img/thumbs/globaldrum.jpg" onError="imgError(this, 'landing')" alt="WorkColumns" />
					<div class="pre-loader"></div>
				</picture>
			</div>
			<div class="overlay">
				<h3 class="col-md-12">Globaldrum</h3>
				<ul class="tags3">
						<li><span class="hashtag">#</span>ux/interaction design,</li>
						<li><span class="hashtag">#</span>waterfall</li>
						<li><span class="hashtag">#</span>user flows,</li>
						<li><span class="hashtag">#</span>information architecture</li>
						<li><span class="hashtag">#</span>wireflows</li>
							<li><span class="hashtag">#</span>b2b white-label</li>
				</ul>
		...
		<article class="column-view col-xs-4 gallery ux" data-work="3m" data-title="3M - Graphics Hub">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4 gallery ux" data-work="scope" data-title="Scope">
			<div class="picture-container">
				<picture>
					<source media="(max-width: 799px)" srcset="img/thumbs/0-scope.jpg" />
					<source media="(min-width: 800px)" srcset="img/thumbs/0-scope.jpg" />
					<img class="placeholder" src="img/work/placeholder-img-square.png" data-src="img/thumbs/1-homerun.jpg" onError="imgError(this, 'landing')" alt="WorkColumns" />
					<div class="pre-loader"></div>
				</picture>
			</div>
			<div class="overlay">
				<h3 class="col-md-12">Scope<br /></h3>
				<ul class="tags3">
						<li><span class="hashtag">#</span>ux strategy,</li>
							<li><span class="hashtag">#</span>ux consultation,</li>
						<li><span class="hashtag">#</span>user research,</li>
						<li><span class="hashtag">#</span>information architecture,</li>
						<li><span class="hashtag">#</span>digital transformation</li>
				</ul>
				<div class="separator"></div>
		...
		<article class="column-view col-xs-4 ux" data-url="./findmypast.php" data-title="Findmypast - Case Study #1">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4 ux" data-url="./findmypast-2.php" data-title="Findmypast - Case Study #2">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="be-training" data-title="Be Training">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="coca-cola" data-title="Coca Cola">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="vectone" data-title="Vectone Mobile">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="wgaming" data-title="W-Gaming">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="rubicon" data-title="Rubicon Project - DSP Builder">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="exterionmedia" data-title="Exterion Media - Dynamic Pricing">
			<div class="picture-container">
				<picture>
		...
		<article class="column-view col-xs-4" data-work="adscout" data-title="AdScout">
			<div class="picture-container">
				<picture>
